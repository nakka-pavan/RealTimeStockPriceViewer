...
STOCK_SYMBOLS = ['AAPL', 'GOOGL', 'MSFT', 'AMZN', 'TSLA', 'META', 'NFLX', 'MU', 'INTC', 'PYPL', 'F', 'WMT', 'KO', 'SNAP', 'SHOP', 'CSCO', 'UBER', 'SBUX', 'ADBE', 'NKE', 'MCD', 'NOK', 'PEP', 'BB', 'ORCL', 'AA', 'SONY']
...
app = dash.Dash(_name_, external_stylesheets=['https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css'])
